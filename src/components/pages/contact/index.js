...
function Contact(props) {
    return (
        <div>
          <footer class="text-center text-white mt-5" id="contact-me">
        <h1 class="display-3 projects text-blue">Contact Me</h1>
        <div class="container pt-4">
            ...
            <a
              ...
              </svg> Bensaebr@gmail.com</a>
            <a
              class="btn btn-link btn-floating btn-lg text-secondary m-1"
              href="https://drive.google.com/file/d/1mf0OGuVPgixLK5RxdQ-Dj7qS1lkroiQi/view?usp=sharing"
              role="button"
              data-mdb-ripple-color="dark"
              target="_blank"
            ...
            <a
              class="btn btn-link btn-floating btn-lg text-secondary m-1"
              href="https://linkedin.com/in/ben-saebr" target="_blank"
              role="button"
              data-mdb-ripple-color="dark"
